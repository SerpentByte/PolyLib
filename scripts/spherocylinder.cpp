...
#include "../headers/spherocylinder.h"
...
void usage()
{
	...
	printf("-l\t<length of cylinder including end-caps>\n");
...
int main(int argc, char* args[])
{
	...
	for(int i=1;i<argc;i++)
	{
		...
		else if(!opt_flag.compare("-l"))
		{
			...
			if(l==0)
			{
				cout<<"Incorrect value of length.\n";
				return 0;
			}
			reqd++;
		}
	...
	pos = spherocylinder(n_beads, sig, r, l, centre, verbose);
		
	if(pos!=NULL)
		write_gro(out, pos, n_beads, xyz(2*r, 2*r, l));
